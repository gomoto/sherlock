...
interface PouchApi {
	...
	//
	put(doc: any, opts?: PouchUpdateOptions, callback?: (err: PouchError, res: PouchUpdateResponse) => void): any;
	put(doc: any, callback?: (err: PouchError, res: PouchUpdateResponse) => void): any;
	//
	// remove == delete
	//
